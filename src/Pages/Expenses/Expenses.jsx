...
function Expenses() {
  ...
  const [expense, setExpense] = useState([]);
   ...
   const handleCheckUpClick = () => {
    ...
    getDataFromCollection('expenses',setExpense); 
    ...
    return (
        <ExpencesStyled className='main sm:px-12 sm:ml-3  md:px-[120px] px-5 pr-1 pb-[120px] pt-[100px] w-full h-screen overflow-y-scroll z-0 relative flex flex-col items-center bg-[#12372A]  opacity-90'>
            ...
            <h1 className='titlel flex flex-col items-center font-bold text-8xl transition duration-500 ease-in-out mb-5 '>Expenses</h1>
                ...
                <div className="expenses-content">
                  {/* Left side */}
                   ...
                   {expense.map(({title,amount,category,description} ,index)=>{
